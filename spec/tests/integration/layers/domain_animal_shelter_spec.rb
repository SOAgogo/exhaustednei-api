...
describe 'Tests Animal API ' do
  ...
  describe 'Shelter information' do
    ...
    it 'HAPPY: should create county shelter entity' do
      county_shelter = @county_shelter_mapper.build_entity(@random_county)
      _(county_shelter).must_equal CORRECT[0].keys
    end
