  ...
  module Value
    ...
    class PetReview
      ...
      def open_now(vet_info)
        ...
        popular_vet = popular_vet.select { |vet| vet[:total_ratings] >= 100 } if popular_vet.empty?
        popular_vet = vet_info.select { |vet| vet[:total_ratings] >= 100 } unless popular_vet.empty?
        popular_vet
      end
